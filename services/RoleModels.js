...
export async function toggleIsRoleModel(userId, data, { skipLoading } = {}) {
    return Requests.put(`users/${userId}/toggleIsRoleModel`, data, {skipLoading}).then(tasks => tasks.data)
}
