...
export default {
  ...
  // Button
  buttonFontFamily: theme.FONT_FAMILY_REGULAR,
  buttonDisabledBg: theme.BUTTON_DISABLED_COLOR,
  buttonSmallFontSize: theme.FONT_SIZE_SMALL,
  buttonLargeFontSize: theme.FONT_SIZE_LARGE,
  buttonPadding: 6,
  ...
  get borderRadiusMedium() {
    return theme.BORDER_RADIUS_MEDIUM;
  },
  get borderRadiusSmall() {
    return theme.BORDER_RADIUS_SMALL;
  },
  get iconSizeLarge() {
  ...
  brandInfo: theme.INFO_COLOR,
  brandSuccess: theme.SUCCESS_COLOR,
  brandDanger: theme.DANGER_COLOR,
  brandWarning: theme.WARNING_COLOR,
  brandDark: theme.DARK_COLOR,
  brandLight: theme.LIGHT_COLOR,
  ...
  // FAB
  fabBackgroundColor: theme.PRIMARY_COLOR,
  fabBorderRadius: 28,
  fabBottom: 0,
  ...
  get inputColorPlaceholder() {
    return theme.INPUT_PLACEHOLDER_COLOR;
  },
  ...
  inverseTextColor: theme.INVERSE_TEXT_COLOR,
  noteFontSize: 14,
  ...
  // Title
  titleFontfamily: theme.FONT_FAMILY_REGULAR,
