...
const CardAtendee = ({ containerStyles, firstName, picture, firstLastName, onPress}) => {
	return(
					...
					<View style={styles.driverPriceContainer}>
						<View style={styles.badgeContainer}>
							<Badge style={styles.badgeItemBlueDark}>
								<MyText fontStyle="semibold" style={styles.textTime}>Asistiré</MyText>
							</Badge>
						</View>
					</View>
				</View>
